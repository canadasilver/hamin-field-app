...
import { LogOut, MapPin, Navigation, CheckCircle2, Clock, Loader2, RefreshCw, LocateFixed } from 'lucide-react'
    ...
    <div className="min-h-screen bg-gray-50 pb-20">
      ...
      <div className="bg-white border-b border-gray-100 px-4 py-3">
        <div className="max-w-lg mx-auto">
          <p className="text-center text-sm font-medium text-gray-700 mb-3">{formatDate(today)}</p>
      ...
      <div className="max-w-lg mx-auto px-4 pt-3 space-y-2 pb-4">
        {loading ? (
          ...
          <div className="text-center py-12 text-gray-400">
            ...
            <p className="text-sm">오늘 배정된 일정이 없습니다</p>
          </div>
        ) : (
          schedules.map((s, i) => {
            const color = STATUS_COLORS[s.status] || '#1976D2'
      ...
      {reassignTarget && (
        <ReassignModal
          ...
          currentDate={reassignTarget.scheduled_date}
